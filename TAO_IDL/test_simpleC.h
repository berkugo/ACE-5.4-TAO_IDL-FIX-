...
#ifndef _TAO_IDL_TEST_SIMPLEC_H_
#define _TAO_IDL_TEST_SIMPLEC_H_
...
#if !defined (_TEST_HELLO__TRAITS_CH_)
#define _TEST_HELLO__TRAITS_CH_
  
  ACE_TEMPLATE_SPECIALIZATION
  struct  Objref_Traits<Test::Hello>
  {
    static Test::Hello_ptr tao_duplicate (
        Test::Hello_ptr
      );
    static void tao_release (
        Test::Hello_ptr
      );
    static Test::Hello_ptr tao_nil (void);
