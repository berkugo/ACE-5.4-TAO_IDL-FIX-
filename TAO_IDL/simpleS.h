...
#ifndef _TAO_IDL_SIMPLES_H_
#define _TAO_IDL_SIMPLES_H_
...
namespace POA_Simple
{
  ...
  public:
    ...
    typedef ::Simple::Hello _stub_type;
    typedef ::Simple::Hello_ptr _stub_ptr_type;
    typedef ::Simple::Hello_var _stub_var_type;
  ...
  public: 
    ...
    static _TAO_Hello_Strategized_Proxy_Broker *
