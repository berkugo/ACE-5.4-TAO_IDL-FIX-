...
#ifndef _TAO_IDL_TEST_SIMPLES_CPP_
#define _TAO_IDL_TEST_SIMPLES_CPP_


#include "test_simpleS.h"
...
/* Command-line: /home/bugur/ACE_wrappers//bin/gperf -m -M -J -c -C -D -E -T -f 0 -F 0,0,0 -a -o -t -p -K opname_ -L C++ -Z TAO_Test_Hello_Perfect_Hash_OpTable -N lookup  */
unsigned int
  ...
  static const class TAO_operation_db_entry  wordlist[] =
    {
      ...
      {"",0,0,0},{"",0,0,0},
      {"sayHello", &POA_Test::Hello::sayHello_skel, &POA_Test::_TAO_Hello_ThruPOA_Proxy_Impl::sayHello, 0},
      {"",0,0,0},
...
class TAO_ServerRequestInfo_Test_Hello_sayHello : public TAO_ServerRequestInfo
{
public:
  TAO_ServerRequestInfo_Test_Hello_sayHello (
...
private:
  TAO_ServerRequestInfo_Test_Hello_sayHello (
      const TAO_ServerRequestInfo_Test_Hello_sayHello &
    );
...
TAO_ServerRequestInfo_Test_Hello_sayHello::TAO_ServerRequestInfo_Test_Hello_sayHello (
    TAO_ServerRequest &_tao_server_request,
...
TAO_ServerRequestInfo_Test_Hello_sayHello::arguments (
...
TAO_ServerRequestInfo_Test_Hello_sayHello::exceptions (
    ACE_ENV_SINGLE_ARG_DECL
  )
  ACE_THROW_SPEC ((CORBA::SystemException))
{
...
CORBA::Any * 
TAO_ServerRequestInfo_Test_Hello_sayHello::result (
    ACE_ENV_SINGLE_ARG_DECL
  )
  ACE_THROW_SPEC ((CORBA::SystemException))
{
...
char *
TAO_ServerRequestInfo_Test_Hello_sayHello::target_most_derived_interface (
...
CORBA::Boolean
TAO_ServerRequestInfo_Test_Hello_sayHello::target_is_a (
    const char * id
    ACE_ENV_ARG_DECL
  )
  ACE_THROW_SPEC ((CORBA::SystemException))
...
void 
TAO_ServerRequestInfo_Test_Hello_sayHello::result (char * result)
{
  // Update the result.
   this->_result = result;
}
...
{
  static POA_Test::_TAO_Hello_Strategized_Proxy_Broker
...
void
POA_Test::_TAO_Hello_ThruPOA_Proxy_Impl::sayHello (
...
void POA_Test::Hello::sayHello_skel (
    TAO_ServerRequest &_tao_server_request,
    void *_tao_servant,
  ...
  )
{
  ...
  TAO_ServerRequestInfo_Test_Hello_sayHello _tao_ri (
      _tao_server_request,
      _tao_upcall,
      _tao_impl
    );
...
{
  POA_Test::Hello *_tao_impl =
    (POA_Test::Hello *) _tao_object_reference;
