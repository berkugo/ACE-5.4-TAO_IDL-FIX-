...
#ifndef _TAO_IDL_TEST_EXAMPLEC_H_
#define _TAO_IDL_TEST_EXAMPLEC_H_
...
#if !defined (_EXAMPLE_CALCULATOR_CH_)
#define _EXAMPLE_CALCULATOR_CH_
  ...
  public:
    ...
    static Calculator_ptr _narrow (
        CORBA::Object_ptr obj
        ACE_ENV_ARG_DECL_WITH_DEFAULTS
      );
    
    static Calculator_ptr _unchecked_narrow (
        CORBA::Object_ptr obj
        ACE_ENV_ARG_DECL_WITH_DEFAULTS
      );
  ...
  protected:
    ...
    Calculator (int collocated = 0);
    
    // These methods travese the inheritance tree and set the
    // parents piece of the given class in the right mode.
    virtual void Example_Calculator_setup_collocation (int collocated);
  ...
  TAO_NAMESPACE_STORAGE_CLASS ::CORBA::TypeCode_ptr _tc_Calculator;
...
#if !defined (_EXAMPLE_CALCULATOR__TRAITS_CH_)
#define _EXAMPLE_CALCULATOR__TRAITS_CH_
  
  ACE_TEMPLATE_SPECIALIZATION
  struct  Objref_Traits<Example::Calculator>
  {
    static Example::Calculator_ptr tao_duplicate (
        Example::Calculator_ptr
      );
    static void tao_release (
        Example::Calculator_ptr
      );
    static Example::Calculator_ptr tao_nil (void);
